const PolicyOptions = () => {
  return (
    <div>
    <ul className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 divide-y sm:divide-y-0 sm:divide-x-2 text-sm text-white pt-8">
